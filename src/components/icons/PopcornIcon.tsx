...
export const PopcornIcon = ({
  ...
  const glowId = useId();
  const fill = active ? `url(#${gradientId})` : "currentColor";
      ...
      {active && (
        <defs>
          <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="45%" stopColor="#fff4b0" />
            <stop offset="100%" stopColor="#b8860b" />
            <animate attributeName="x1" values="-30%;0%;130%" dur="2.4s" repeatCount="indefinite" />
            <animate attributeName="x2" values="70%;100%;230%" dur="2.4s" repeatCount="indefinite" />
          </linearGradient>
          <filter id={glowId} x="-50%" y="-50%" width="200%" height="200%">
            <feDropShadow dx="0" dy="0" stdDeviation="2" floodColor="#f8d36b" floodOpacity="0.85" />
          </filter>
        </defs>
      )}
      <path
